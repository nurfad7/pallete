...
const Testimonials: FC = () => {
  ...
  return (
    <div className="w-full min-h-[100vh] flex flex-col gap-5 pb-5 bg-product">
      <div className="relative w-full h-40 flex mb-10">
      ...
      <div className="relative w-full flex gap-20 overflow-y-hidden overflow-x-auto hide-scrollbar text-center">
        <div ref={scroll1} className="flex gap-10 min-w-max animate-gallery pt-20">
          <div className="w-screen h-[50vh] flex flex-col px-24 gap-10">
            ...
            <div className="text-xl text-black font-medium">David Brooks - General Contractor, Brooks Construction</div>
          </div>
          <div className="w-screen h-[50vh] flex flex-col px-24 gap-10">
            <div className="flex justify-center items-center">
              <Icon icon="star" />
            ...
            <div className="text-xl text-black font-medium">Sarah Mitchell - Interior Designer, Mitchell & Co. Designs</div>
          </div>
          <div className="w-screen h-[50vh] flex flex-col px-24 gap-10">
            <div className="flex justify-center items-center">
              <Icon icon="star" />
            ...
            <div className="text-xl text-black font-medium">Emily Adams - CEO, Adams Real Estate Group</div>
          </div>
          <div className="w-screen h-[50vh] flex flex-col px-24 gap-10">
            <div className="flex justify-center items-center">
              <Icon icon="star" />
            ...
            <div className="text- text-black font-medium">Liam Turner - Restaurant Owner, Urban Eats Bistro</div>
          </div>
          <div className="w-screen h-[50vh] flex flex-col px-24 gap-10">
            <div className="flex justify-center items-center">
              <Icon icon="star" />
            ...
            <div className="text-xl text-black font-medium">Rachel Cooper - Homeowner</div>
          </div>
        </div>
      </div>
    </div>
