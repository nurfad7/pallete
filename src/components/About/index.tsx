...
const About: FC<AboutProps> = ({setIsShow}) => {
  return (
    <div id="about" 
      className='w-full min-h-[100vh] md:min-h-[100vh] flex flex-col justify-center px-20'>
      <div className="hidden md:block relative z-10 md:text-9xl font-bold leading-[0.5] pt-20">ABOUT</div>
      <div className="relative z-20 flex flex-col md:flex-row w-full min-h-[42rem] md:min-h-80">
        ...
        <div className="flex w-full md:w-[50%] h-auto md:h-80 mb-2 md:mb-0">
          <Image src="https://res.cloudinary.com/dhu6ayhdj/image/upload/f_auto,q_auto/v1/pallete/mjfslnr0qub7ccv6qkzl" 
        ...
        <div className="flex flex-col w-full md:w-[30%] pl-5">
          ...
          <div onClick={setIsShow} className="font-bold text-sm cursor-pointer mb-5 md:mb-0">Learn more</div>
        </div>
      </div>
